    ...
    */
    ...
    'employees' => [
        ...
        'export' => [
            ...
            'excel' => 'Excel',
            'csv' => 'CSV',
            'no_rows' => 'No employees to export.',
            'yes' => 'Yes',
            'no' => 'No',
            'columns' => [
    ...
    'overtime' => [
        ...
        'requests' => [
            ...
            'my' => [
                ...
                'description' => 'Request overtime and review the status of your requests.',
                'new' => 'Request overtime',
    ...
    'dt' => [
        ...
        'reports' => [
            'title' => 'Reports',
            'description' => 'Generate the attendance and workday reports required by Resolución 38.',
            'coming_soon' => 'This report will be available soon.',
            'types' => [
                'attendance' => 'Attendance report',
                'daily' => 'Daily workday report',
                'shift-changes' => 'Shift changes report',
                'sundays' => 'Sundays and holidays report',
                'incidents' => 'Technical incidents report',
            ],
            'filters' => [
                'type' => 'Report type',
                ...
                'end' => 'To date',
                'employees' => 'Employees',
                'employees_all' => 'All employees',
                'employees_search' => 'Search by name or RUT',
                'positions' => 'Positions',
                'positions_all' => 'All positions',
                'positions_search' => 'Search position',
                'premises' => 'Premises',
            ...
            'daily' => [
                'title' => 'Daily workday report',
                'description' => 'Daily and weekly hours worked by each worker over the selected range (Resolución 38, Art. 27 b).',
                'no_workers' => 'No hay trabajadores que coincidan con la selección',
                ...
                'header' => [
                    'flexible_band' => 'Subject to time band',
                ],
                'columns' => [
                    'date' => 'Date',
                    'journey' => 'Pacted ordinary journey',
                    'journey_marks' => 'Journey marks',
                    'lunch' => 'Lunch',
                    'lunch_marks' => 'Lunch marks',
                    'undertime' => 'Time short',
                    'overtime' => 'Overtime',
                    'other_marks' => 'Other marks',
                    'observations' => 'Observations',
                    'exceptional_cycle' => 'Cycles (exceptional distribution)',
                ],
                'export' => [
                    'excel' => 'Excel',
                    'pdf' => 'PDF',
            ...
            'sundays' => [
                'title' => 'Sundays/holidays report',
                'description' => 'Sundays and holidays worked by each worker over the selected range (Resolución 38, Art. 27 c).',
                'no_workers' => 'No hay trabajadores que coincidan con la selección',
                'no_sundays' => 'La jornada de este trabajador no incluye domingos o festivos',
                'additional_flag' => 'Retail worker with additional Sunday rest',
                'yes' => 'Yes',
                'no' => 'No',
                'justified' => 'Justified',
                'unjustified' => 'Unjustified',
                ...
                'columns' => [
                    'additional' => 'Additional Sunday rest',
                    'date' => 'Date',
                    'attendance' => 'Attendance',
                    'absence' => 'Absence',
                    'observations' => 'Observations',
    ...
    'documents' => [
        ...
        'api' => [
            'pdf_not_ready' => 'The signed PDF is not available for this document yet.',
        ],
    ...
    'payroll_reports' => [
        ...
        'filters' => [
            ...
            'collaborator_all' => 'All',
            'match_count' => ':count employee(s) match the filters',
            ...
            'facet' => [
                'clear' => 'Clear',
                'done' => 'Done',
                'no_selection' => 'None selected — every value is included',
                'selected_summary' => ':count selected',
            ],
            'chips' => [
            ...
            'status' => [
                'none_title' => 'No employee selected',
                'none_subtitle' => 'Use the Employee filter or the button to select them in bulk',
                'all_title' => 'Everyone matching the filters',
                'all_subtitle' => 'If you change the filters, the selection adjusts on its own',
                'all_subtitle_with_excluded' => ':count excluded by hand — the selection still follows the filters',
                'manual_title' => ':count selected one by one',
                'manual_subtitle' => 'Changing the filters does not affect this selection',
            ],
            'excluded' => [
                'title' => 'Excluded by hand (:count) — kept even if you change the filters',
                'undo' => 'Include again',
            ],
        ],
        ...
        'summary' => [
            ...
            'regenerate_hint' => 'You changed the period or the selection — regenerate the report to see it updated.',
            ...
            'export' => [
                ...
                'csv' => 'CSV',
                'pdf' => 'PDF',
                'confirm_required' => 'You must confirm the unresolved-data warning before exporting.',
            ],
            'groups' => [
                'employee' => 'Employee',
                'hours' => 'Hours',
                'overtime' => 'Overtime',
                'absences' => 'Absences',
                'sundays_holidays' => 'Sundays and holidays',
                'paid_days' => 'Paid days',
                'non_paid_days' => 'Non-paid days',
            ],
            'columns' => [
                'employee' => 'Employee',
                'rut' => 'RUT',
                'worked_hours' => 'Regular hours',
                'non_worked_hours' => 'Non-worked hours',
                'lateness' => 'Lateness',
                'overtime_ordinary' => 'Overtime 50%',
                'overtime_sunday_holiday' => 'Overtime 100%',
                'overtime_compensated' => 'Compensated overtime',
                'overtime_unauthorized' => 'Unauthorized overtime',
                'justified_absences' => 'Justified',
                'unjustified_absences' => 'Unjustified',
                'sundays_holidays_worked' => 'Worked',
                'paid_worked_days' => 'Worked',
                'paid_vacation_days' => 'Vacation',
                'paid_leave_days' => 'Paid leave',
                'non_paid_unjustified_days' => 'Unjustified',
                'non_paid_medical_days' => 'Medical leave',
