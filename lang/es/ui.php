    ...
    */
    ...
    'employees' => [
        ...
        'export' => [
            ...
            'excel' => 'Excel',
            'csv' => 'CSV',
            'no_rows' => 'No hay trabajadores para exportar.',
            'yes' => 'Sí',
            'no' => 'No',
            'columns' => [
                'first_name' => 'Nombre',
    ...
    'workdays' => [
        ...
        'columns' => [
            ...
            'shift' => 'Turno',
            'leave' => 'Permiso',
            'overtime' => 'Horas extras autorizadas',
        ],
        ...
        'overtime' => [
            'statuses' => [
                'not_opened' => 'Sin autorizar',
            ],
            'actions' => [
                'approve' => 'Aprobar horas extra',
                'revoke' => 'Eliminar autorización',
            ],
            'bulk' => [
                'trigger_approve' => 'Aprobar horas extra',
                'approve_title' => 'Aprobar horas extra en bloque',
                'approve_description' => 'Se aprobarán íntegramente las :count jornadas seleccionadas con horas extra sin autorizar. Una jornada con anomalías sin revisar, o que exceda un tope legal sin motivo, quedará sin autorizar.',
                'reason' => 'Motivo',
                'submit' => 'Confirmar',
            ],
        ],
        ...
        'show' => [
            ...
            'overtime' => [
                ...
                'revoke_dialog' => [
                    'title' => 'Eliminar autorización de horas extra',
                    'description' => 'Jornada de :employee del :date. El registro se conserva con el motivo de la eliminación; las marcas originales no se modifican.',
                    'reason' => 'Motivo',
                    'submit' => 'Eliminar',
                ],
                'errors' => [
                ...
                'flash' => [
                    ...
                    'revoked' => 'Autorización de horas extra eliminada.',
    ...
    'payroll_reports' => [
        ...
        'filters' => [
            ...
            'period_prev_year' => 'Año anterior',
            'period_next_year' => 'Año siguiente',
            'period_types' => [
                'month' => 'Mes completo',
            ...
            'collaborator_all' => 'Todos',
            'match_count' => ':count trabajador(es) coinciden con los filtros',
            ...
            'facet' => [
                'clear' => 'Limpiar',
                'done' => 'Listo',
                'no_selection' => 'Ninguno seleccionado — se incluyen todos',
                'selected_summary' => ':count seleccionados',
            ],
            'chips' => [
            ...
            'status' => [
                'none_title' => 'Ningún trabajador seleccionado',
                'none_subtitle' => 'Use el filtro Colaborador o el botón para seleccionar en bloque',
                'all_title' => 'Todos los que coinciden con los filtros',
                'all_subtitle' => 'Si cambia los filtros, la selección se ajusta sola',
                'all_subtitle_with_excluded' => ':count excluido(s) a mano — la selección sigue a los filtros',
                'manual_title' => ':count seleccionados uno por uno',
                'manual_subtitle' => 'Cambiar los filtros no altera esta selección',
            ],
            'excluded' => [
                'title' => 'Excluidos a mano (:count) — se mantienen aunque cambie los filtros',
                'undo' => 'Volver a incluir',
            ],
        ],
        ...
        'summary' => [
            ...
            'regenerate_hint' => 'Cambiaste el período o la selección — vuelve a generar el informe para verlo actualizado.',
            ...
            'total_row' => 'Total empresa',
            'employee_count' => ':count trabajador(es)',
            'export' => [
                'title' => 'Exportar',
                'excel' => 'Excel',
                'csv' => 'CSV',
            ...
            'groups' => [
                ...
                'overtime' => 'Horas extra',
                'absences' => 'Ausencias',
                'sundays_holidays' => 'Domingos y festivos',
                'paid_days' => 'Días pagados',
                'non_paid_days' => 'Días no pagados',
            ],
            'columns' => [
                'employee' => 'Trabajador',
                'rut' => 'RUT',
                'worked_hours' => 'Horas normales',
                'non_worked_hours' => 'Horas no trabajadas',
                'lateness' => 'Atraso',
                'overtime_ordinary' => 'HHEE 50%',
                'overtime_sunday_holiday' => 'HHEE 100%',
                'overtime_compensated' => 'HHEE compensada',
                'overtime_unauthorized' => 'HHEE no autorizada',
                'justified_absences' => 'Justificadas',
                'unjustified_absences' => 'Injustificadas',
                'sundays_holidays_worked' => 'Trabajados',
                'paid_worked_days' => 'Trabajados',
                'paid_vacation_days' => 'Vacaciones',
                'paid_leave_days' => 'Permiso con goce',
                'non_paid_unjustified_days' => 'Injustificado',
                'non_paid_medical_days' => 'Licencia médica',
