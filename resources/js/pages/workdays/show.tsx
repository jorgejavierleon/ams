...
function hm(time: string | null): string | null {
 ...
 */
function AttendanceStrip({ workday }: { workday: Workday }) {
...
export default function WorkdayShow({
    ...
    function submitReview() {
        ...
        const { action, modification } = reviewTarget;
        const route =
            action === 'approve'
                ? approve({
                      workday: workday.id,
                      markModification: modification.id,
                  })
                : decline({
                      workday: workday.id,
                      markModification: modification.id,
                        ...
                        <div>
                            ...
                            <div className="mt-0.5 text-sm text-muted-foreground">
                                {workday.employee.name ? (
                                    <Link
                                        href={
                                            showEmployee(workday.employee.id)
                                                .url
                                        }
