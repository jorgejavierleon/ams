{{-- Altas: employees whose contract_start_date falls in the period
...
<table>
    <thead>
        <tr>
            ...
            <th>{{ __('ui.payroll_reports.movements.columns.hire_date') }}</th>
        </tr>
    </thead>
    <tbody>
        @forelse ($rows as $row)
        ...
        @empty
            <tr>
                <td colspan="5" class="legend">{{ __('ui.payroll_reports.movements.empty.hires') }}</td>
            </tr>
        @endforelse
    </tbody>
</table>
